  ...
  return (
    <LegalPage title="Datenschutzerklärung">
      ...
      <p>
        ...
        auf den Servern des Hosters gespeichert. Hierbei kann es sich v.&nbsp;a. um IP-Adressen, Kontaktanfragen, Meta- und
      ...
      <p>
        <strong>Wir nutzen folgenden Hoster:</strong><br />
      ...
      <table>
        ...
        <tbody>
          <tr><td>Auskunft</td><td>Sie können Auskunft über Ihre gespeicherten Daten verlangen.</td></tr>
          <tr><td>Berichtigung</td><td>Unrichtige Daten können Sie berichtigen lassen.</td></tr>
          <tr><td>Löschung</td><td>Unter bestimmten Voraussetzungen können Sie die Löschung verlangen.</td></tr>
          <tr><td>Einschränkung</td><td>Sie können die Einschränkung der Verarbeitung verlangen.</td></tr>
          <tr><td>Datenübertragbarkeit</td><td>Sie können Ihre Daten in maschinenlesbarem Format erhalten.</td></tr>
          <tr><td>Widerspruch</td><td>Sie können der Verarbeitung jederzeit widersprechen.</td></tr>
          <tr><td>Beschwerde</td><td>Sie können sich bei der Aufsichtsbehörde beschweren.</td></tr>
        </tbody>
      </table>

      <p className="!mt-10">
        <strong>Kontakt für Datenschutzanfragen:</strong><br />
        FIT-INN Trier · Auf Hirtenberg 8 · 54296 Trier<br />
        E-Mail: info@fit-inn-trier.de · Telefon: 0651 308524
      </p>
    </LegalPage>
  )
}
