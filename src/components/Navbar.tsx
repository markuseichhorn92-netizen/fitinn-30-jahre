    ...
    >
      <div className="mx-auto max-w-6xl px-5 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-6">
          <a href="/#warum" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Aktion</a>
          ...
          <a href="/#fragen" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">FAQ</a>
          ...
          <a href="/#termin" className="btn-cta inline-flex items-center gap-2 !py-2 !px-4 !text-sm">
      ...
      {menuOpen && (
        <div className="md:hidden bg-background/98 backdrop-blur-md border-b border-border px-5 pb-4">
          <div className="flex flex-col gap-3">
            <a href="/#warum" onClick={() => setMenuOpen(false)} className="text-sm font-medium py-2 border-b border-border/50">Aktion</a>
            ...
            <a href="/#fragen" onClick={() => setMenuOpen(false)} className="text-sm font-medium py-2 border-b border-border/50">FAQ</a>
            <a href="/#termin" onClick={() => setMenuOpen(false)} className="btn-cta inline-flex items-center justify-center gap-2 mt-2">
