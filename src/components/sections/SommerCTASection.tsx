    ...
    <section id="kontakt" className="py-20 md:py-32 px-5 relative overflow-hidden" style={{ backgroundColor: '#f7f1e6' }}>
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4">
          Starte jetzt in deinen <span className="text-accent headline-accent">beitragsfreien Sommer</span>
        </h2>
        <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto">
          Buch dein kostenloses Probetraining oder melde dich direkt — wir beraten dich gerne persönlich in Trier-Feyen.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          <a href="tel:+49651308524" className="btn-outline w-full sm:w-auto justify-center">
        ...
        {/* Studio-Infos */}
        <div className="grid sm:grid-cols-2 gap-6 text-sm text-left max-w-lg mx-auto">
